<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApagarClientes.aspx.cs" Inherits="CantinaTioWell.ApagarClientes" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
     ...
     <h2 class="mb-0">Deletar Clientes
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnDeletaCli" Text="Deletar" runat="server" OnClick="btnDeletaCli_Click" CssClass="btn btn-danger"/>
        </div>
    </form>
           </section>
    </div>
